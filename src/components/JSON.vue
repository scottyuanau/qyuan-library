...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="work in austen?.famousWorks" :key="work.title">
          {{ work.title }} <span v-if="work.year">({{ work.year }})</span>
        </li>
      </ul>
    </section>
    ...
    <section class="lab-section">
      ...
      <!-- Picker -->
      <label for="authorPick">Pick an author to highlight: </label>
      <select id="authorPick" v-model="highlightName">
      ...
      <!-- Highlighted author list (re-uses the same authors data) -->
      <ul>
        <li
          v-for="author in authors"
          :key="author.id"
          :class="{ highlight: author.name === highlightName }"
          :title="`Born: ${author.birthYear}`"
        >
          {{ author.name }} ({{ author.birthYear }})
        </li>
      </ul>
